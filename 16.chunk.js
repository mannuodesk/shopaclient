...
var Home = (function () {
    ...
    Home.prototype.populateProducts = function (categoryId, pageNumber, pageSize, searchString) {
        if (this.flag != 0) {
            jQuery('.loader-products').show();
        }
        // jQuery('.no-products').hide();
        this.flag = this._productService.popalateProducts(categoryId, pageNumber, pageSize, searchString);
        //teamMembers?.length > 0
        //this.products=this._productService.products;
        console.log("In Commponent");
        console.log(ProductService_1.ProductService.PaginationFlag);
        if (pageNumber == 0) {
        }
        else {
            if (this.flag == 0) {
    ...
    Home.prototype.onWindowScroll = function () {
        ...
        if (pos == max) {
            ...
            this.populateProducts(this.categoryId, this.pageNumber, this.pageSize, this.searchString);
        }
    };
