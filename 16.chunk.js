...
var Home = (function () {
     ...
     * end
     */
    function Home(fb, _productService, sharedService, _productdetail, router, _shoppingCartService, _reviewsAndRatingsService) {
        var _this = this;
        this.fb = fb;
        ...
        * */
        ...
        jQuery(document).ready(function () {
            jQuery(".more-btn").hover(function () {
                jQuery(this).css({ 'color': 'white', 'background-color': "#34bac5 " });
            }, function () {
                jQuery(this).css({ 'color': '#34bac5', 'background-color': "white " });
            });
            jQuery(".cat-drop-triger-hash").hover(function () {
                jQuery(".cat-dropdown-hash").slideDown();
            }, function () {
                jQuery(".cat-dropdown-hash").slideUp();
            });
            ...
            jQuery("#dropdownCats").hover(function () {
                jQuery(".more-btn").css({ 'color': 'white', 'background-color': "#34bac5 " });
            }, function () {
                jQuery(".more-btn").css({ 'color': '#34bac5', 'background-color': "white" });
            });
        });
        this._productService.getAllCategories().subscribe(function (a) {
            if (a.code == StatusCodeEnum_1.StatusCodeEnum.SUCCESS) {
                ...
                _this.hashTags = a.data;
                var loop = 7;
                var width = $(window).width();
                console.log(width);
                if (width >= 751 && width < 800) {
                    loop = 3;
                }
                if (width <= 900 && width >= 800) {
                    loop = 3;
                }
                if (width >= 901 && width <= 999) {
                    loop = 4;
                }
                if (width >= 1000 && width <= 1099) {
                    loop = 4;
                }
                if (width >= 1100 && width <= 1199) {
                    loop = 5;
                }
                if (width >= 1200 && width <= 1299) {
                    loop = 5;
                }
                if (width >= 1300 && width <= 1399) {
                    loop = 7;
                }
                if (width >= 1400 && width <= 1499) {
                    loop = 7;
                }
                if (width >= 1500 && width <= 1599) {
                    loop = 8;
                }
                if (width >= 1600 && width <= 1699) {
                    loop = 8;
                }
                if (width >= 1700 && width <= 1799) {
                    loop = 9;
                }
                if (width >= 1800 && width <= 1899) {
                    loop = 10;
                }
                if (width >= 1900 && width <= 1999) {
                    loop = 10;
                }
                if (width >= 2000 && width <= 2099) {
                    loop = 11;
                }
                if (width >= 2100 && width <= 2199) {
                    loop = 11;
                }
                if (width >= 2200 && width <= 2299) {
                    loop = 12;
                }
                if (width >= 2300 && width <= 2399) {
                    loop = 13;
                }
                if (width >= 2400 && width <= 2499) {
                    loop = 13;
                }
                if (width >= 2500 && width <= 2599) {
                    loop = 14;
                }
                if (width >= 3800 && width <= 3900) {
                    loop = 34;
                }
                if (width >= 5100 && width <= 5200) {
                    loop = 44;
                }
                for (var i = 0; i < _this.categories.length; i++) {
                    if (i < loop) {
                        _this.topCategories.push(_this.categories[i]);
                        _this.topHash.push(_this.categories[i]);
                    }
                    else {
                        _this.dropdownCategories.push(_this.categories[i]);
                        _this.dropdownHash.push(_this.categories[i]);
                    }
                }
            }
        });
        this.populateProducts(this.categoryId, 0, this.pageSize, this.searchString);
    }
    ...
    Home.prototype.populateRelatedProducts = function (categoryId, pageNumber, pageSize) {
        var _this = this;
        this._productService.getAllProducts(categoryId, pageNumber, pageSize, -1, -1).subscribe(function (a) {
            if (a.code == StatusCodeEnum_1.StatusCodeEnum.SUCCESS) {
                _this.relatedProducts = a.data;
            }
        });
    };
    Home.prototype.populateProducts = function (categoryId, pageNumber, pageSize, searchString, min, max) {
        if (this.flag != 0) {
            jQuery('.loader-products').show();
        }
        this.flag = this._productService.popalateProducts(categoryId, pageNumber, pageSize, searchString, min, max);
        if (pageNumber == 0) {
        }
        else {
            if (this.flag == 0) {
        ...
        //if()
        /*
        this._productService.getAllProducts(categoryId, pageNumber, pageSize).subscribe(
          a => {
            if (a.code == StatusCodeEnum.SUCCESS) {
              if (pageNumber == 0) {
                if (a.data.length == 0) {
    ...
    Home.prototype.onResize = function (event) {
        ...
        for (var i = 0; i < this.categories.length; i++) {
            if (i < loop) {
                this.topCategories.push(this.categories[i]);
                this.topHash.push(this.categories[i]);
            }
            else {
                this.dropdownCategories.push(this.categories[i]);
                this.dropdownHash.push(this.categories[i]);
            }
        }
    };
    Home.prototype.onCategoryClick = function (categoryId) {
        ...
        this.pageNumber = 0;
        this.searchString = "";
        ProductService_1.ProductService.searchString = "";
        this.populateProducts(this.categoryId, 0, this.pageSize, this.searchString, -1, -1);
    };
    ...
    Home.prototype.rightClick = function (event, productId) {
        ...
        if (width > 768) {
            if (event.which == 3) {
                window.open('#/app/product-detail?productId=' + productId + '&categoryId=' + this.categoryId, '_newtab'); // To open in new tab
            }
            else {
    ...
    Home.prototype.ngOnInit = function () {
        ...
        this.products = ProductService_1.ProductService.products;
        $('.owl-2').owlCarousel({
            loop: true,
            margin: 10,
            autoWidth: true,
    ...
    Home.prototype.onWindowScroll = function () {
        ...
        if (pos == max) {
            ...
            this.populateProducts(this.categoryId, this.pageNumber, this.pageSize, this.searchString, this.minPrice, this.maxPrice);
        }
    };
    Home.prototype.onSubmitSearchCriteria = function () {
        ProductService_1.ProductService.products.length = 0;
        this.populateProducts(this.categoryId, 0, 25, "", this.minPrice, this.maxPrice);
    };
    Home.prototype.shareWithFacebook = function () {
        var params = {
            href: "http://shopafrontend.azurewebsites.net/#/app/product-detail?productId=10",
            method: 'share'
        };
        this.fb.ui(params)
    ...
    Home.prototype.shareWithTwitter = function () {
    ...
    ], Home.prototype, "wishlistModalComponent", void 0);
    __decorate([
    ...
    Home = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_c = typeof ng2_facebook_sdk_1.FacebookService !== 'undefined' && ng2_facebook_sdk_1.FacebookService) === 'function' && _c) || Object, (typeof (_d = typeof ProductService_1.ProductService !== 'undefined' && ProductService_1.ProductService) === 'function' && _d) || Object, (typeof (_e = typeof SharedService_1.SharedService !== 'undefined' && SharedService_1.SharedService) === 'function' && _e) || Object, (typeof (_f = typeof ProductDetailsService_1.ProductDetailsService !== 'undefined' && ProductDetailsService_1.ProductDetailsService) === 'function' && _f) || Object, (typeof (_g = typeof router_1.Router !== 'undefined' && router_1.Router) === 'function' && _g) || Object, (typeof (_h = typeof ShoppingCartService_1.ShoppingCartService !== 'undefined' && ShoppingCartService_1.ShoppingCartService) === 'function' && _h) || Object, (typeof (_j = typeof ReviewsRatingsService_1.ReviewsRatingsService !== 'undefined' && ReviewsRatingsService_1.ReviewsRatingsService) === 'function' && _j) || Object])
    ], Home);
    return Home;
