...
var routes = [
    { path: '', component: weblayout_component_1.WebLayout, children: [
            ...
            { path: 'index', loadChildren: function () { return __webpack_require__.e/* System.import */(4).then(__webpack_require__.bind(null, "./src/app/home/home.module.ts")).then(function (mod) { return (mod.__esModule && mod.default) ? mod.default : mod; }); } },
            { path: 'product-detail', loadChildren: function () { return __webpack_require__.e/* System.import */(5).then(__webpack_require__.bind(null, "./src/app/productdetail/productdetail.module.ts")).then(function (mod) { return (mod.__esModule && mod.default) ? mod.default : mod; }); } }
        ] }
];
