...
var Header = (function () {
    ...
    Header.prototype.attachSignin = function (element) {
        ...
        this.auth2.attachClickHandler(element, {}, function (googleUser) {
            ...
            this._signinsignup.userSignup(googleCustomer).subscribe(function (a) {
                console.log(a);
                _this.user = new User_1.User();
                _this.user = a.data;
                localStorage.setItem('user', JSON.stringify(_this.user));
    ...
    Header.prototype.signUpWithGmail = function () {
    ...
    Header.prototype.signInWithGmail = function () {
        ...
        this.attachSignin(document.getElementById('googleSignInBtn'));
    };
    /**
    End
     */
