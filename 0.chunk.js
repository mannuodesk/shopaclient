...
var Header = (function () {
    function Header(sharedService, fb, _signinsignup, shoppingCartService) {
        var _this = this;
        ...
        if (checkErrors == 0) {
            ...
            this._signinsignup.userSignup(emailCustomer).subscribe(function (a) {
                if (a.code == 200) {
                    ...
                    _this.registrationError = a.data[0];
    ...
    Header.prototype.ngOnInit = function () {
        jQuery("body").on("click", ".admin-options-triger", function (e) {
            var $this = $(this);
            e.preventDefault();
            jQuery(".admin-options").slideToggle(250);
        });
        jQuery('body').on("click", function (e) {
            if (jQuery(e.target).closest('.admin-options-triger').length === 0) {
                jQuery(".admin-options").slideUp();
            }
        });
    ...
    Header = __decorate([
        core_1.Component({
            ...
            encapsulation: core_1.ViewEncapsulation.None,
            providers: [SigninSignupService_1.SigninSignupService, ShoppingCartService_1.ShoppingCartService, SharedService_1.SharedService]
        }), 
