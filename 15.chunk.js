    ...
    function Home(_productService, _productdetail) {
        ...
        this._productService.getAllCategories().subscribe(function (a) {
            if (a.code == StatusCodeEnum_1.StatusCodeEnum.SUCCESS) {
                ...
                console.log(_this.dropdownCategories);
            }
        });
        this._productService.getAllProducts().subscribe(function (a) {
            if (a.code == StatusCodeEnum_1.StatusCodeEnum.SUCCESS) {
...
var ProductService = (function () {
    ...
    ProductService.prototype.getAllProducts = function () {
        return this.http.get(this.urlService.baseUrl + 'api/default/GetAllProductsDisplayedOnHomePage')
            .map(function (res) { return res.json(); });
    };
