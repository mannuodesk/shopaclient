...
var CartComponent = (function () {
    function CartComponent(_shoppingCartService, router) {
        ...
        var cartCount = 0;
        this._shoppingCartService.getShoppingCartCount(this.user.Id).subscribe(function (a) {
            cartCount = Object.keys(a.data.shoppingCartItemDTOList).length;
        });
        if (cartCount == 0) {
    ...
    CartComponent.prototype.onQuantityChange = function (shoppingCartItemId, quantity) {
        var _this = this;
