...
var ProductDetail = (function () {
    ...
    ProductDetail.prototype.openthis = function (id) {
        alert(id);
        window.open('#/app/product-detail?productId=' + id + '&categoryId=' + this.categoryId); // To open in new tab  
    };
